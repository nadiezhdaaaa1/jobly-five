...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Stack+Sans+Headline:wght@200;300;400&family=Stack+Sans+Notch:wght@400&family=Stack+Sans+Text:wght@200;300;400;500;600&display=swap",
      },
    ],
  }),

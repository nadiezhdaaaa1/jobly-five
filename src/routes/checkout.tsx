// Mock checkout. No payment provider is wired yet, so "Pay" writes the
// subscription row through the existing server action and shows confirmation.
// Everything shown here is derived from src/config/pricing.ts.
          ...
          <div className="flex flex-col gap-4 rounded-[20px] border border-[color:var(--color-border)] bg-[color:var(--color-surface-1)] p-6">
            ...
            <p className="text-[15px] text-[color:var(--color-text-secondary)]">
              {isTrial
                ...
                : `Your Pro plan is active. You can manage or cancel it any time in Settings.`}
            </p>
            <button
              type="button"

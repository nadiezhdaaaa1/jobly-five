...
function Hero() {
  ...
  return (
    <section className="relative isolate overflow-hidden lg:mx-12">
      ...
      <div className="pointer-events-none absolute bottom-0 right-0 z-10 h-[300px] w-[270px] overflow-hidden sm:h-[355px] sm:w-[325px] md:h-[425px] md:w-[390px] lg:h-[520px] lg:w-[575px]">
        <img
          src={heroAsset.url}

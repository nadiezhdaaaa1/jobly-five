...
function HeroCard() {
  return (
    <div className="relative">
      <div className="h-[280px] overflow-hidden rounded-[20px] border border-[color:var(--color-border)] bg-[color:var(--color-mint)] md:h-[360px] lg:h-[460px]" />
      {/* Floating match reveal card */}
      <div className="absolute left-5 top-5 z-0 w-[240px] rounded-[16px] border border-[color:var(--color-border)] bg-[color:var(--color-surface-1)] p-4 shadow-[0_8px_24px_rgba(0,0,0,0.08)] md:w-[280px] lg:w-[320px]">
      ...
      <img
        ...
        className="absolute bottom-0 right-0 z-10 h-[320px] w-full rounded-[20px] object-cover object-right md:h-[420px] lg:h-[520px]"
      />
    </div>
  );
}
